...
const photoshootPrompts = [
  'Make the models wear a red satin suit',
  'Add dramatic lighting to the scene',
  'Create a high-fashion editorial look',
  'Make the models pose elegantly',
  'Add luxury accessories and jewelry',
  'Create a cinematic composition',
  'Make the models look confident and powerful',
  'Add professional makeup and styling'
];

export const PhotoshootStep: React.FC<PhotoshootStepProps> = ({ 
  onNext, 
  onBack, 
  initialData,
  modelImages = [],
  ...
  const allImages = [...modelImages, ...poseImages, ...backgroundImages];

  return (
    <div className="space-y-6">
      <Card title="Photoshoot Generation" variant="glow">
        <div className="space-y-6">
          {/* Available Images */}
          {allImages.length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-green-400 mb-4">Available Images</h4>
          ...
          <div>
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-sm font-medium text-green-400">Image Groups</h4>
            ...
            {groups.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <p>No image groups created yet</p>
                <p className="text-sm">Click &quot;Add Group&quot; to start creating photoshoot groups</p>
              </div>
            ) : (
                ...
                {groups.map((group, groupIndex) => (
                  <div key={groupIndex} className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                    <div className="flex justify-between items-start mb-4">
                      <h5 className="text-sm font-medium text-green-400">Group {groupIndex + 1}</h5>
                      <Button 
                        variant="danger" 
                    ...
                    <div className="mb-4">
                      ...
                      <div className="space-y-1 mb-2">
                        {photoshootPrompts.map((prompt, index) => (
                          <button
                            key={index}
