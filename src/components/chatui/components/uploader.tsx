...
export default function Uploader({ isOpen, onClose }: UploaderProps) {
          ...
          >
            ...
            >
              <div className='flex flex-col items-center gap-4'>
                ...
                <button className='px-6 py-2 rounded-lg bg-white/10 border border-white/20 text-white hover:bg-white/15 transition-all text-sm font-medium'>
                  Browse Files
                </button>
              </div>
            </div>
